@extends('home')
@section('title')
    {{"Feedback - Latest Opinion and Response"}}
@endsection
@section('master')
                                ...
                                <form class="form-vertical" role="form" method="post" action="#" class="response-form">
                                    ...
                                    <div class="form-group" style="margin-top:25px;">
                                        ...
                                        <div class="col-sm-10" style="margin-top:7px;">
                                            <input type="text" class="col-sm-12 form-control" id="answer" name="answer" placeholder="Describe your opinion in three words." value="">
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-top:25px;">
                                        ...
                                        <div class="col-sm-10" style="margin-top:7px;">
                                            <textarea class="col-sm-12 form-control" rows="4" name="response" id="response"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="responses col-md-12 col-xs-12" id="{{$rspns->username}}">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div style="display: inline-block;" class="col-md-6">
                                        <?php
                                            $ifagreed=agreed($rspns->posts_id,Session::get('logged')[0]['user']);
                                        ?>
                                        @if(count($ifagreed)>0)
                                            <span class="col-sm-3"><img src="{!! url('design/images/liked.png') !!}" width="35%">  {{count(liked($rspns->posts_id))}}</span>
                                            @else
                                                <form action="{{url('/student/feedback/likes')}}" class="form-inline" style="float:left; width:20%;" method="post">
                                                    <input type="hidden" name="txtUsername" id="txtUsername" value="{{Session::get('logged')[0]['user']}}">
                                                    <input type="hidden" name="txtPostsId" id="txtPostsId" value="{{$rspns->posts_id}}">
                                                    <input type="hidden" name="txtAgrees" id="txtAgrees" value="1">
                                                    <input type="hidden" name="txtDisagrees" id="txtDisagrees" value="0">
                                                    <input type="image" src="{!! url('design/images/Like.png') !!}" class="col-sm-8" id="btnLike"> {{count(liked($rspns->posts_id))}}
                                                </form>
                                            @endif
                                            <?php
                                                $ifdisagreed=disagreed($rspns->posts_id,Session::get('logged')[0]['user']);
                                            ?>
                                            @if(count($ifdisagreed)>0)
                                                <span class="col-sm-3"><img src="{!! url('design/images/disliked.png') !!}" width="35%"> {{count(disliked($rspns->posts_id))}}</span>

                                                @else
                                                <form action="{{url('/student/feedback/likes')}}" class="form-inline" style="float:left; width: 20%;" method="post">
                                                    <input type="hidden" name="txtUsername" id="txtUsername" value="{{Session::get('logged')[0]['user']}}">
                                                    <input type="hidden" name="txtPostsId" id="txtPostsId" value="{{$rspns->posts_id}}">
                                                    <input type="hidden" name="txtAgrees" id="txtAgrees" value="0">
                                                    <input type="hidden" name="txtDisagrees" id="txtDisAgrees" value="1">
                                                    <input type="image" src="{!! url('design/images/dislike.png') !!}" class="col-sm-8" id="btnDisLike" name="btnDisLike">  {{count(disliked($rspns->posts_id))}}
                                                </form>
                                        @endif
                                    </div>
        ...
        <div id="editpopup" class="modal-box">
            @foreach($opinionDtl as $opinion)
                ...
                <div class="modal-body">
                    {{--<div class="row">
                        <div class="col-md-12">--}}
                    <form id="frmOpinion" action="#" class="opinion-form" method="post">
                        ...
                        <div class="form-group" style="margin-top:25px;">
                            ...
                            <div class="col-sm-10" style="margin-top:7px;">
                                <select class="form-control" name="ddlClassId" id="ddlClassId">
                        ...
                        <div class="form-group" style="margin-top:25px;">
                            ...
                            <div class="col-sm-10" style="margin-top:7px;">
                                <input type="text" class="col-sm-12 form-control" name="OpinionTitle" id="OpinionTitle" value="{{$opinion->title}}">
                            </div>
                        </div>
                        <div class="form-group" style="margin-top:25px;">
                            <label for="opinion" class="col-sm-12 control-label" style="margin-top:15px;">Text of Opinion Piece:</label>
                            <div class="col-sm-10" style="margin-top:7px;">
                                <textarea id="opinion" class="ckeditor form-control" cols="50" rows="4" name="opinion">{{$opinion->description}}</textarea>
                            </div>
                        </div>
                        <div id="words-left col-sm-12"></div>
                        <!-- <div class="form-group" style="margin-top:25px;">
                        ...
                        <div class="form-group" style="margin-top:25px;">
                            ...
                            <div class="col-sm-10" style="margin-top:7px;">
                                <input type="text" class="col-sm-12 form-control" name="qstn" id="Qstn" value="{{$opinion->qstn_to_be_ans}}">
                            </div>
                        </div>
                        <div class="form-group" style="margin-top:25px;">
                            <div class="col-sm-5" style="margin-top:7px;">
                                <input type="text" class="col-sm-3 form-control" name="txtAvailDt" id="txtAvailDt" placeholder="Date Set" value="{!! date('m/d/Y',strtotime($opinion->avail_dt)) !!}">
                            </div>
                            <div class="col-sm-5" style="margin-top:7px;">
                                <input type="text" class="col-sm-3 form-control" name="txtDeadlineDt" id="txtDeadlineDt" value="{!! date('m/d/Y',strtotime($opinion->deadline_dt)) !!}" placeholder="Deadline">
                            </div>
                        </div>
